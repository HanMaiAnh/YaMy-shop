...
.nav-link { color:#555 !important; font-weight:500; border-radius:8px; padding:0.5rem 1rem !important; transition:0.3s; }
...
<nav class="navbar navbar-expand-lg navbar-light sticky-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <!-- THANH TÌM KIẾM -->
      <form class="d-flex navbar-search my-2 my-lg-0" role="search" method="get" action="<?= BASE_URL ?>/view/products.php">
      ...
      <ul class="navbar-nav ms-auto align-items-center">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link <?= ($current_page ?? '') === 'home' ? 'active' : '' ?>" href="<?= BASE_URL ?>/view/index.php">
...
document.querySelectorAll('.dropdown-submenu').forEach(function (menu) {
    ...
    // Khi rê vào cả vùng menu cha
    menu.addEventListener('mouseenter', function() {
        submenu.classList.add('show');
    });

    // Khi rê chuột ra khỏi cả vùng cha + submenu
