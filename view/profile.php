...
$hasFullName = in_array('full_name', $existingCols, true);
...
if ($hasFullName) $selectCols[] = 'full_name';
            ...
            <div class="col-lg-9">
                ...
                <div class="profile-body">
                    <form method="post" action="update_profile.php">
                        ...
                        <!-- Tên hiển thị -->
                        <div class="profile-row">
                            <div class="profile-row-label">Tên</div>
                            <div class="profile-row-control">
                                <input type="text" name="full_name" class="form-control"
                                       value="<?= htmlspecialchars($full_name ?: $username) ?>">
                            </div>
                        </div>
