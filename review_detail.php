...
// Accept either product id (id) or review_id and convert to product id
$productId = null;
if (isset($_GET['review_id']) && is_numeric($_GET['review_id'])) {
    $rid = (int)$_GET['review_id'];
    $stmt = $pdo->prepare("SELECT product_id FROM reviews WHERE id = :rid LIMIT 1");
...
<body>
    ...
    <div class="content">
        <a href="reviews.php" class="btn-back"><i class="fa fa-arrow-left"></i> Quay lại</a>
        ...
        <div class="card">
            <div class="product-top">
                ...
                <div class="product-info">
                    ...
                    <div class="meta-row">
                        <div class="meta-badge"><?= number_format($avgRating, 2) ?> ★ (<?= $totalReviews ?>)</div>
        ...
        <div class="card">
            <div class="card-header"><h2>Tất cả bình luận (<?= $totalReviews ?>)</h2></div>
                            ...
                            <div class="review-body">
                                <div class="review-header">
                                    ...
                                    <div class="review-right">
                                        ...
                                        <div class="review-meta"><?= date('Y-m-d H:i:s', strtotime($rv['created_at'])) ?></div>
                                    </div>
                                </div>
                                ...
                                <div style="margin-top:8px;">
                                    <form method="post" action="reviews.php" style="display:inline;">
                                        <input type="hidden" name="hide_review" value="<?= (int)$rv['id'] ?>">
