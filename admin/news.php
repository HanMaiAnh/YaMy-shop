...
require_once __DIR__ . '/../config/db.php'; // $pdo from here
...
// Build base query keep for pagination links
$keep = [];
...
<head>
    ...
    <style>
        * {margin:0; padding:0; box-sizing:border-box; font-family: 'Montserrat', sans-serif;}
        ...
        .filter-bar form { width:100%; display:flex; align-items:center; gap:12px; flex-wrap:wrap; }
        .filter-input {
            padding:12px 14px;
        ...
        /* khi nút thêm ở trong form, đẩy nó sang phải */
    ...
    <div class="content">
        ...
        <div class="filter-bar">
            <form method="get" action="news.php">
                <input type="text" name="q" class="filter-input" placeholder="Tìm tin tức" value="<?= h($q) ?>">
                ...
                <!-- Nút thêm nằm trong form, được đẩy sang phải bằng .add-btn-right -->
                <a href="news_add.php" class="add-btn add-btn-right">+ Thêm tin tức</a>
            </form>
        </div>
